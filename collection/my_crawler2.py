...
# 엑셀로 저장하기 위한 변수
RESULT_PATH = 'C:\project\tutorial\collection'
...
def crawler(maxpage, query, sort, s_date, e_date):
    ...
    while page <= maxpage_t:
        url = "https://search.naver.com/search.naver?&where=news&query=" + query + "&sort=" + sort + "&field=1" +"&ds=" + s_date + "&de=" + e_date + "&nso=so%3Ar%2Cp%3Afrom" + s_from + "to" + e_to + "%2Ca%3A&start=" + str(
            page)
